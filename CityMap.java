...
public class CityMap
{
  ...
  public static int getCityZone(String address){
    if(validAddress(address) == false){
      ...
      int [] part = getCityBlock(address);
      if(part[1] >= 1 && part[1] <= 5 && part[0]>= 1 && part[0] <= 5){
          return 3;
      }
      else if(part[1] >= 1 && part[1] <= 5 && part[0] >= 6 && part[0] <= 9){
        return 0;
      }
      else if(part[1] >= 6 && part[1] <= 9 && part[0]>= 1 && part[0] <= 5){
          return 2;
        }
      else if(part[1] >= 6 && part[1] <= 9 && part[0]>= 6 && part[0] <= 9){
        return 1;
      }
      else{
        return -1;
